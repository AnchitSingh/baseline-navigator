...
export class BaselineDiagnosticProvider {
    ...
    private initializePatterns() {
        ...
        this.cssFeaturePatterns.set('css-has', /:hasKATEX_INLINE_OPEN/gi);
        ...
        this.cssFeaturePatterns.set('calc', /calcKATEX_INLINE_OPEN/gi);
        this.cssFeaturePatterns.set('clamp', /clampKATEX_INLINE_OPEN/gi);
        this.cssFeaturePatterns.set('min', /minKATEX_INLINE_OPEN/gi);
        this.cssFeaturePatterns.set('max', /maxKATEX_INLINE_OPEN/gi);
